...
Проект создан для отработки современных технологий Java/Spring Boot на уровне **Junior → Middle**.
...
Проект открыт для вклада! Если хочешь помочь — создавай Issue или Pull Request.

Особенно приветствуется помощь с **фронтендом**.
...
1. Скопируй этот README в проект
2. Замени плейсхолдер баннера на реальную картинку (когда сделаешь)
3. Добавь скриншоты позже (особенно когда будет фронт)

Хочешь, я сейчас сделаю:
- Версию README на английском (для GitHub)
- Или продолжим улучшать Entity / Auth?

Пиши, что нужно дальше! 🚀